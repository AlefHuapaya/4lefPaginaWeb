...
export default async function LoginPage({
  ...
  return (
    <div className="app-shell-background flex flex-1 items-center justify-center px-4">
      <div className="w-full max-w-sm rounded-xl border border-slate-200 bg-white p-6 shadow-lg">
        <h1 className="mb-1 text-lg font-semibold text-entel-blue">Portal de apoyo</h1>
